...
class JobManager {
  ...
  */
    ...
    async processCreateApplicationRecord(jobId, { name, owner, description, environment }, progressCallback) {
        ...
        const { createApplicationRecordData } = await import('../api/applications/applicationRecords.controller.js');
    ...
    async processDeleteApplicationRecord(jobId, { recordId }, progressCallback) {
        const { deleteApplicationRecordData } = await import('../api/applications/applicationRecords.controller.js');
